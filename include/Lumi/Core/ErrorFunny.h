...
namespace Lumi::ErrorHandler {
	static std::vector<std::string> LUMI_FUNNY_ERROR_MESSAGES = {
			...
			"Have you tried turning it off and on again? (Also, check Stack Overflow).",
			"Error: Segmentation fault (of our collective sanity).",
			"It's not a bug, it's a feature. A very, *very* specific feature. (Googling might help).",
			"Lumi encountered an unexpected `nullptr`. Please provide more dereferenceable objects.",
			...
			"You've been disconnected from the server. Probably lag.",
